...
public class FilteringController {
    ...
    public MappingJacksonValue retrieveSomeBean() {
        SomeBean someBean = new SomeBean("value1", "value2", "value3", "field4", "field5");
    ...
    public MappingJacksonValue retrieveAsListSomeBean() {

        List someBeans =  Arrays.asList(new SomeBean("value1", "value2", "value3", "value4", "value5"),
                new SomeBean("value11", "value22", "value33", "field4", "field5")
        );
